...
while True:
    ...
    if table_contour is not None:
        ...
        if pink_paper_box is not None:
            ...
            lower_yellow = np.array([50, 50, 145])
            upper_yellow = np.array([95, 95, 190])  #actually kinda red now lol          
        ...
        if origin is not None and y_direction is not None:
            ...
            for center, radius, distance_cm, angle_degrees, X_coordinate, Y_coordinate in ball_measurements:
                ...
                cv2.putText(frame, f"Cartesian coordinates:", (50,460), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (20, 100, 20), 2)
